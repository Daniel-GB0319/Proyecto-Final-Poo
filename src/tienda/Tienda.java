...
public class Tienda{
    ...
    // Se declaran variables y objetos necesarios para el programa
        int menu=1, submenu=0, i=0,j=0,k=0, numClientes=1, numCoches=1, numEmpleados=1, numContratos=1;
    ...
    // Se inicializan Objetos Base
        ...
        do{ // Bucle para que funcione el programa hasta que usuario decida salir               
            ...
            // Menu Principal
            System.out.println("********* MARCA DE LA EMPRESA *********");
            ...
            switch(menu){
                case 1: // Opcion Menu Principal 1) Catalogo de Vehiculos
                    do{
                        ...
                        System.out.println("********* MARCA DE LA EMPRESA *********");
                        System.out.println("---- Catalogo de Vehiculos Registrados ----");
                        ...
                        switch(submenu){// SubMenu de Catalogo
                            ...
                            case 2: // Opcion Catalogo 2) Ver Detalles Especificos de un Coche
                                if (numCoches!=1){
                                    System.out.println("Ingrese el Numero Correspondiente al Inciso del Vehiculo que desea ver y pulse Enter: ");
                                    i = read.nextInt();
                                    if(i<=numCoches && i>=1){
                                        coches[i].showDetallesVehiculoFull();
                                    } else {
                                        System.out.println("!!!Opcion No Corresponde con algun Inciso Mostrado!!!");
                ...
                case 2: // Opcion Menu Principal 2) Comprar Coche
                    if(numClientes>1 && numCoches>1 && numEmpleados>1){ // Si hay elementos para crear un contrato
                        ...
                        i = read.nextInt();
                        System.out.println("Ingrese el Numero correspondiente al Empleado que realiza la Venta: ");
                        j = read.nextInt();
                        System.out.println("Ingrese el Numero correspondiente al Vehiculo que se desea Comprar: ");
                        k = read.nextInt();
                        contratos[numContratos].crearContrato(clientes[i], empleados[j], coches[k], numContratos);
                        numContratos++;
                ...
                do{
                    ...
                    System.out.println("********* MARCA DE LA EMPRESA *********");
                    System.out.println("---- Lista de Contratos Registrados ----");
                    ...
                    switch(submenu){// SubMenu de Gestion de Contratos
                        ...
                        if (numContratos!=1){
                            System.out.println("Ingrese el Numero Correspondiente al Inciso del Contrato que desea ver y pulse Enter: ");
                            i = read.nextInt();
                        ...
                        case 2: // Opcion Catalogo 2) Ver Detalles Especificos de un Coche
                            if (numContratos!=1){
                                System.out.println("Ingrese el Numero Correspondiente al Inciso del Contrato que desea realizar el Pago y pulse Enter: ");
                                i = read.nextInt();
                                if(i<=numContratos && i>=1){
                        ...
                        case 3: // Opcion Gestion Pedidos 3) Cancelar Contrato
                            if (numContratos!=1){
                                System.out.println("Ingrese el Numero Correspondiente al Inciso del Contrato que desea Cancelar y pulse Enter: ");
                                i = read.nextInt();
                                if(i<=numContratos && i>=1){
                ...
                do{
                    ...
                    switch(submenu){// SubMenu de Gestionar Clientes
                        ...
                        case 2: // Opcion Gestionar Clientes 2) Ver Detalles Especificos de un Cliente
                            if (numClientes!=1){
                                System.out.println("Ingrese el Numero Correspondiente al Inciso del Cliente que desea ver y pulse Enter: ");
                                i = read.nextInt();
                ...
                do{
                    ...
                    switch(submenu){// SubMenu de Gestionar Empleados
                        ...
                        case 2: // Opcion Gestionar Empleados 2) Ver Detalles Especificos de un Empleado
                            if (numEmpleados!=1){
                                System.out.println("Ingrese el Numero Correspondiente al Inciso del Empleado que desea ver y pulse Enter: ");
                                i = read.nextInt();
                        ...
                        if (numEmpleados!=1){
                            System.out.println("Ingrese el Numero Correspondiente al Inciso del Empleado que desea Cambiar Salario y pulse Enter: ");
                            i = read.nextInt();
                            if(i<=numEmpleados && i>=1){
